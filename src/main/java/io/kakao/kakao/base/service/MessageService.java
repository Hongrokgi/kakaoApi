package io.kakao.kakao.base.service;

import io.kakao.kakao.dto.DefaultMessageDto;
...
public class MessageService extends HttpCallService{
    ...
    private static final String SUCCESS_CODE = "0"; // kakao api에서 return 해주는 success code 값
